...
if (isset($_POST['tambahDataSiswa'])) {
	...
	$query = mysqli_query($conn, "INSERT INTO identitas_siswa SET NIK = '$nik',
																	  ...
																	  tgl_buat = '$tgl_buat' ") or die(mysqli_error($conn)); //changed
											
	if ($query) {
		// session login
		$_SESSION['nikPeserta'] = $nik;
...
if (isset($_POST['loginDataPeserta'])) {
	...
	$query = mysqli_query($conn, "SELECT * FROM identitas_siswa WHERE NIK = '$nik' AND Tanggal_Lahir = '$tanggal_lahir'") or die(mysqli_error($conn));
	...
	if (mysqli_num_rows($query) > 0) {
		...
		$_SESSION['alert'] = '<div class="alert alert-danger alert-has-icon" id="alert">
			                        ...
			                        <div class="alert-body">
			                          ...
			                          NIK dan Tanggal Lahir anda tidak cocok.
			                        </div>
			                      </div>';
...
if (isset($_GET['logout'])) {
	unset($_SESSION['nikPeserta'], $_SESSION['namaPeserta'], $_SESSION['tlPeserta'], $_SESSION['status_ortu']);
