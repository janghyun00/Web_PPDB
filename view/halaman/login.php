    ...
    <section class="section">
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            <img src="../../assets/style/images/logosd.png" alt="logo" width="80" class="shadow-light rounded-circle mb-5 mt-2">
            <h4 class="text-dark font-weight-normal">Selamat datang di halaman<span class="font-weight-bold"> PPDB</span></h4>
            <p class="text-muted">Jika belum memiliki akun, silahkan daftar terlebih dahulu</p>
            <?php
        ...
        <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative" data-background="../../assets/img/unsplash/login_bg.jpg">
