      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href=""><img src="../../assets/style/images/logosd.png" alt="LP" width="30px"> PPDB</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href=""><img src="../../assets/style/images/logosd.png" alt="LP" width="47px"></a>
          </div>
            ...
            <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
              <button class="btn btn-primary btn-lg btn-block btn-icon-split" onclick="cetak(<?= $_SESSION['nikPeserta']; ?>)">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form class="needs-validation" novalidate="" action="../../controller/admin/daftar.php" method="POST">
		      <div class="modal-body">
			      ...
			      <?php 
	                ...
	                $data = mysqli_query($conn, "SELECT Id_Identitas_Siswa FROM identitas_siswa WHERE NIK = '$_SESSION[nikPeserta]'") or die(mysqli_error($conn));

	                if (mysqli_num_rows($data) != 1) { echo "<script>window.location.href = 'daftarSiswa.php';</script>"; }
	                
	                foreach ($data as $hmm) { 
	          	  ?>
			      <input type="text" class="form-control" required="" value="<?= $_SESSION['nikPeserta'] ?> | <?= $_SESSION['namaPeserta'] ?>" disabled>
        	...
        	<?php } else { ?>
          	...
          	<?php 
          		$idne = $_SESSION['nikPeserta'];
          		
          		include('../../config/connection.php');
                $data = mysqli_query($conn, "SELECT a.*, b.NIK, b.Id_Identitas_Siswa as id_identitas FROM orang_tua_wali a 
