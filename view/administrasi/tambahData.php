		      ...
		      <div class="modal-body">
			      ...
			      <select class="form-control" name="peserta" required="">
			        ...
			        <?php 
			        	...
			        	$data = mysqli_query($conn, "SELECT Id_Identitas_Siswa, NIK, Nama_Peserta_Didik FROM identitas_siswa 
			        											WHERE status_administrasi = 0");
			        	foreach ($data as $r) {
			        ?>
			        <option value="<?= $r['Id_Identitas_Siswa']; ?>"><?= $r['NIK'] . " | " . $r['Nama_Peserta_Didik']; ?></option>
			    	<?php } ?>
			      </select>
			    </div>
