              ...
              <table class="table table-striped" id="table-1">
                ...
                <tbody>
                  <?php
                    ...
                    $no = 1;
                    $data = mysqli_query($conn, "SELECT a.*, b.NIK, b.Nama_Peserta_Didik, b.Id_Identitas_Siswa FROM administrasi a 
                  ...
                  <tr>
                    ...
                    <td class="text-center" width="120px">
                      ...
                      <a href="#" class="btn btn-primary" onclick="cetak(<?= $row['NIK']; ?>)"><i class="fas fa-print"></i></a>
                  	</td>
                  </tr>
              	  <?php } ?>
                </tbody>
