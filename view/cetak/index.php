...
<body style="width: 900px; font-family: unset;">
  ...
  <div class="container-fluid">
  	<p style="font-size: 15px;font-weight: bold;text-align: center; width: 800px;">
  	  SDN 3 PURBALINGGA LOR<br>
  	  Jl. Kopral Tanwir, PURBALINGGA LOR, Kec. Purbalingga, Kab. Purbalingga, Jawa Tengah<br>
  	  No. Telp : ------
  	</p>
  	<br>
  	...
  	<div class="row">
  	  <div class="col-md-6">
  	    ...
  	    <table >
  	      <tr> <td width="110px">NIK</td> <td width="20px">:</td> <td width="300px"><?= $row['NIK'] ?></td> </tr>
