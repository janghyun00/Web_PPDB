              ...
              <table class="table table-striped" id="table-1">
                ...
                <tbody>
                  <?php
                    ...
                    $no = 1;
                    $data = mysqli_query($conn, "SELECT Id_Identitas_Siswa, NIK, Nama_Peserta_Didik, Tanggal_Lahir, Alamat_Tinggal, tgl_ubah FROM identitas_siswa") or die(mysqli_error($conn));
                    foreach ($data as $row) { 
                  ?>
                  <tr>
                  	<td><?= $no++; ?></td>
